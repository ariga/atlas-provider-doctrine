...
final class CommandTest extends TestCase
{
    ...
    {
        $output = shell_exec("php bin/doctrine atlas:dump-sql --dialect mysql --path ./tests/entities");
...
';
    ...
    {
        exec("php bin/doctrine atlas:dump-sql --dialect bad_dialect --path ./tests/entities", $output, $return_var);
    ...
    {
        exec("php bin/doctrine atlas:dump-sql --dialect mysql --path /bad/path", $output, $return_var);
        $this->assertEquals(1, $return_var);
