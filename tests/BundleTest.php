...
class BundleTest extends TestCase
{
    public function testRegisterCommandsNoConfig(): void
    {
        ...
        $expected = "CREATE TABLE UserCommands (id INT AUTO_INCREMENT NOT NULL, command VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB;\n";
    ...
    public function testRegisterCommandsWithConfig(): void
    {
        ...
        $expected = "CREATE TABLE user_commands (id INT AUTO_INCREMENT NOT NULL, command VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB;\n";
        $this->assertEquals($expected, $commandTester->getDisplay());
    }
}
